...
%--------------------------------------
\begin{UseCase}{CU25}{Consultar lista de periodo de ETS }{
    ...
    \UCitem{Errores}{
        ...
        E2: Cuando no hay ningún periodo de ETS dado de alta se muestra el mensaje {\bf MSG11-}  ``Ningún periodo de ETS ha sido dado de alta.''
    }
...
\begin{UCtrayectoria}
\UCpaso[\UCactor] El Personal de gestión escolar accede a la pantalla \IUref{IU24}{ Consultar lista de periodo de ETS }\label{CU24.introduceDatos}.
