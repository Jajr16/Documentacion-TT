...
%--------------------------------------
\begin{UseCase}{CU02}{Consultar calendario escolar}{
    ...
    \UCitem{Errores}{
        E1: Cuando es periodo de ETS el sistema muestra el mensaje {\bf MSG7-}{``Actualmente es periodo de ETS.''}

        E2: Cuando no se ha establecido un periodo de ETS actual, el sistema muestra el mensaje {\bf MSG8-}{``Actualmente el periodo de ETS no ha sido establecido.''}
