...
%--------------------------------------
\begin{UseCase}{CU23}{Crear credencial}{
    ...
    \UCitem{Errores}{
        ...
        E3: Cuando la CURP o la boleta del alumno ya estén registrados el sistema muestra el mensaje {\bf MSG10-}{``La CURP o la boleta ya han sido asociadas a este alumno con anterioridad u otro alumno.''}
    }
...
\begin{UCtrayectoria}
    \UCpaso[\UCactor] El Personal de la DAE accede a la pantalla \IUref{IU22}{Crear credencial }\label{CU22.introduceDatos}
...
\UCpaso[\UCactor] El Personal de la DAE es redirigido a la pantalla \IUref{IUE023}{ Capturar fotografía estudiantil }.
\end{UCtrayectoria}
