...
%--------------------------------------
\begin{UseCase}{CU32}{Consultar lista de personal de seguridad}{
    ...
    \UCitem{Errores}{
        ...
        E2: Cuando no hay ningún usuario personal de seguridad dado de alta se muestra el mensaje {\bf MSG13-}  ``No hay personal de seguridad dado de alta.''
    }
...
\begin{UCtrayectoria}
\UCpaso[\UCactor] El Personal de gestión escolar accede a la pantalla \IUref{IU32}{ Consultar lista de personal de seguridad }\label{CU32.introduceDatos}.
...
\UCpaso[\UCactor] El Personal de gestión escolar es redirigido a la pantalla \IUref{IU33}{Dar de alta personal de seguridad}.
\end{UCtrayectoria}
