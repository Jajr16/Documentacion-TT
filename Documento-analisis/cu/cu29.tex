...
%--------------------------------------
\begin{UseCase}{CU29}{Dar de alta ETS }{
    Permitir al personal de gestión escolar dar de alta un nuevo ETS.
         ...
         \UCitem{Salidas}{Muestra mensaje {\bf MSG17-} ``ETS  dado de alta con éxito''.}
         \UCitem{Destino}{Pantalla \IUref{IU28}{Consultar lista de ETS} }
         ...
         \UCitem{Errores}{
            ...
            E3: Cuando el dato ETS o salón ya están registradas en el sistema, el proceso no se realiza y se muestra el mensaje {\bf MSG18-}{`` ETS o salón  ya han sido asociadas a un ETS de ETS.''}
         }
     ...
     \begin{UCtrayectoria}
         ...
         \UCpaso[\UCactor] El Personal de gestión escolar accede a la pantalla \IUref{IU29}{ Dar de alta ETS }\label{CU29.introduceDatos} e introduce los datos del ETS {\hyperlink{ETS.ETS }{ETS},  \hyperlink{ETS.Periodo -de-ETS }{ Periodo -de-ETS},  \hyperlink{ETS.Fecha}{Fecha},  \hyperlink{ETS.Turno}{Turno},  \hyperlink{ETS.Cupo} {Cupo} ,  \hyperlink{ETS.Unidad-de-aprendizaje }{Unidad-de-aprendizaje},  \hyperlink{ETS.Salon}{Salon} y \hyperlink{ETS.Docente}{Docente} .
         ...
         \UCpaso[\UCactor] El Personal de gestión escolar es redirigido a la pantalla \IUref{IU28} Consultar lista de ETS}.
