...
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
	...
	\cdtEntityRelSection
	\brRel{}{Programa\_académico}{ \hyperlink{ESCOM}{ESCOM} está compuesto por un \hyperlink{PA}{Programa\_académico}}	
	\brRel{}{Persona}{Una \hyperlink{Persona}{Persona} pertenece a \hyperlink{ESCOM}{ESCOM}}	
\end{cdtEntidad}
%---------------------------------------------------------
...
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	\cdtEntityRelSection
	\brRel{}{Unidad\_aprendizaje}{Un \hyperlink{PA}{Programa\_academico} está compuesto por una \hyperlink{UA}{Unidad\_aprendizaje}}	
	\brRel{}{ESCOM}{\hyperlink{ESCOM}{ESCOM} está compuesto por un \hyperlink{PA}{Programa\_académico}}	
\end{cdtEntidad}
%---------------------------------------------------------
\begin{cdtEntidad}{Persona}{Persona}
	...
	%- - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	\cdtEntityRelSection
	\brRel{}{ESCOM}{Una \hyperlink{Persona}{Persona} pertenece a \hyperlink{ESCOM}{ESCOM}}	
	\brRel{}{Docente}{Una \hyperlink{Persona}{Persona} es un \hyperlink{Docente}{Docente}}	
	\brRel{}{Personal\_Seguridad}{Una \hyperlink{Persona}{Persona} es un \hyperlink{PS}{Personal\_Seguridad}}
...
\begin{cdtEntidad}{PS}{Personal\_Seguridad}
	...
	%- - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	\cdtEntityRelSection
	\brRel{}{Persona}{Un \hyperlink{PS}{Personal\_Seguridad} es una \hyperlink{Persona}{Persona}}
\end{cdtEntidad}
%---------------------------------------------------------
...
\begin{cdtEntidad}{Usuario}{Usuario}
	...
	\brRel{}{Tipo\_Usuario}{Un \hyperlink{Usuario}{Usuario} tiene un \hyperlink{TU}{Tipo\_Usuario}}
\end{cdtEntidad}
%---------------------------------------------------------
